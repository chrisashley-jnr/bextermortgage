...
export const TeamSection = () => {
  const experts = [
    { name: "Alissa Smith", role: "Mortgage Expert", img: "https://i.pravatar.cc/300?u=1" },
    { name: "Sarah Jones", role: "Senior Advisor", img: "https://i.pravatar.cc/300?u=2" },
    { name: "David Wilson", role: "Finance Expert", img: "https://i.pravatar.cc/300?u=3" },
    { name: "Emily Brown", role: "Loan Specialist", img: "https://i.pravatar.cc/300?u=4" },
    { name: "James Taylor", role: "Manager", img: "https://i.pravatar.cc/300?u=5" },
    { name: "Jessica Miller", role: "Broker", img: "https://i.pravatar.cc/300?u=6" },
    { name: "Ben Johnson", role: "Technician", img: "https://i.pravatar.cc/300?u=7" },
    { name: "Anna Davis", role: "Mortgage Ad", img: "https://i.pravatar.cc/300?u=8" },
  ];
